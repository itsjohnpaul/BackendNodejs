...
const ServerSelectionError = require('mongoose/lib/error/serverSelection');
const SyncIndexesError = require('mongoose/lib/error/syncIndexes');
...
const CreateCollectionsError = require('mongoose/lib/error/createCollectionsError');
