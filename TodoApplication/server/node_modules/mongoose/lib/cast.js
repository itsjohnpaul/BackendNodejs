...
const Types = require('mongoose/lib/schema/index');
const cast$expr = require('mongoose/lib/helpers/query/cast$expr');
const castString = require('mongoose/lib/cast/string');
const castTextSearch = require('mongoose/lib/schema/operators/text');
...
const isOperator = require('mongoose/lib/helpers/query/isOperator');
