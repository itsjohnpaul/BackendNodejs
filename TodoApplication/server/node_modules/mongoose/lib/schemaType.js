...
const $exists = require('mongoose/lib/schema/operators/exists');
...
const isAsyncFunction = require('mongoose/lib/helpers/isAsyncFunction');
const isSimpleValidator = require('mongoose/lib/helpers/isSimpleValidator');
const schemaTypeSymbol = require('mongoose/lib/helpers/symbols').schemaTypeSymbol;
const utils = require('mongoose/lib/utils');
const validatorErrorSymbol = require('mongoose/lib/helpers/symbols').validatorErrorSymbol;
