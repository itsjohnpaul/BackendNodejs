...
const symbols = require('mongoose/lib/schema/symbols');
...
const documentHooks = require('mongoose/lib/constants').documentMiddlewareFunctions;
...
Schema.prototype.interpretAsType = function(path, obj, options) {
  ...
  const MongooseTypes = this.base?.Schema.Types ?? Schema.Types;
  const Types = this.base?.Types ?? require('mongoose/lib/types');
