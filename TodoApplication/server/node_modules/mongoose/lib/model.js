...
const isInPathsToSave = require('mongoose/lib/helpers/document/isInPathsToSave');
...
const { buildMiddlewareFilter } = require('mongoose/lib/helpers/buildMiddlewareFilter');
...
const {
  ...
  arrayAtomicsSymbol,
  modelSymbol
} = require('mongoose/lib/helpers/symbols');
...
Model.hydrate = function(obj, projection, options) {
  ...
  const document = require('mongoose/lib/queryHelpers').createModel(this, obj, projection, projection, options);
