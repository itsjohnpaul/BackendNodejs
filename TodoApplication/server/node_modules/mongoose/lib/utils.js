...
const isObject = require('mongoose/lib/helpers/isObject');
const isMongooseArray = require('mongoose/lib/types/array/isMongooseArray');
const isMongooseDocumentArray = require('mongoose/lib/types/documentArray/isMongooseDocumentArray');
const isBsonType = require('mongoose/lib/helpers/isBsonType');
const isPOJO = require('mongoose/lib/helpers/isPOJO');
const getFunctionName = require('mongoose/lib/helpers/getFunctionName');
const isMongooseObject = require('mongoose/lib/helpers/isMongooseObject');
const schemaMerge = require('mongoose/lib/helpers/schema/merge');
...
exports.toObject = function toObject(obj) {
  Document || (Document = require('mongoose/lib/document'));
  let ret;
...
exports.isPOJO = require('mongoose/lib/helpers/isPOJO');
